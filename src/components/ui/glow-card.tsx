...
const glowColorMap = {
    blue: { base: 215, spread: 0, saturation: 70, lightness: 60 },
    ...
    // monochrome: dark-blue → silver/white, no hue cycling
    silver: { base: 215, spread: 0, saturation: 25, lightness: 80 },
}
    ...
    return (
        <>
            ...
            <div
                ...
                data-glow
                style={inlineStyles}
                className={`${getSizeClasses()} ${!customSize ? '' : ''} relative grid rounded-2xl shadow-[0_1rem_2rem_-1rem_black] backdrop-blur-[5px] ${className}`}>
                <div data-glow></div>
                {children}
            </div>
        </>
